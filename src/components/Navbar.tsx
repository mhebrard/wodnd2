                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:block">
                        <div className="ml-10 flex items-baseline space-x-4">
                            <Link href="/" className="flex items-center space-x-1 px-3 py-2 rounded-md text-sm font-bold hover:bg-surface-hover hover:text-primary transition-colors font-[family-name:var(--font-cinzel)]">
