        ...
        <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-slate-900 rounded-xl border border-slate-800 p-8 mb-8 relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
                    <div>
                        <div className="flex items-center gap-3 text-amber-400 font-mono text-sm mb-2">
                            <span className="bg-amber-500/10 px-2 py-1 rounded border border-amber-500/20">{post.campaign}</span>
                            <span className="text-slate-500">Level {post.level}</span>
                        </div>
                        <h1 className="text-5xl font-bold text-white mb-2 font-[family-name:var(--font-cinzel)]">{post.name}</h1>
                        <div className="text-xl text-slate-400 flex gap-2 font-sans">
                            <span>{post.race}</span>
            ...
            <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-2 space-y-8">
                    <div className="bg-slate-900/50 rounded-xl p-8 border border-slate-800">
                        <h2 className="text-2xl font-bold text-slate-200 mb-6 flex items-center gap-2 font-[family-name:var(--font-cinzel)]">
                ...
                <div className="space-y-6">
                    <div className="bg-slate-900 rounded-xl p-6 border border-slate-800">
                        <h3 className="text-lg font-bold text-slate-200 mb-4 flex items-center gap-2 font-[family-name:var(--font-cinzel)]">
                            <Sword className="h-5 w-5 text-red-400" />
                            Combat Stats
                        </h3>
                        <div className="space-y-4">
                            <div className="flex justify-between items-center border-b border-slate-800 pb-2">
                                <span className="text-slate-400 font-sans">HP</span>
                                <span className="font-mono text-green-400 font-bold">32 / 32</span>
                            </div>
                            <div className="flex justify-between items-center border-b border-slate-800 pb-2">
                                <span className="text-slate-400 font-sans">AC</span>
                                <span className="font-mono text-slate-200 font-bold">15</span>
                            </div>
                            <div className="flex justify-between items-center border-b border-slate-800 pb-2">
                                <span className="text-slate-400 font-sans">Initiative</span>
